package com.example.apoo.railwayprojectapoorva.adapter.autocompadap;
...
import com.example.apoo.railwayprojectapoorva.entities.autocom.Station;
...
public class AutoCompleteStationAdapter extends ArrayAdapter<Station> implements Filterable {
    ...
    private String STATION_URL2= "/apikey/01u8xbb1/";
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View view = inflater.inflate(R.layout.single_row_autocomp_stat, parent, false);

        //get Country
        Station station = mStation.get(position);

        TextView stationName = (TextView) view.findViewById(R.id.stationNameAdap);
